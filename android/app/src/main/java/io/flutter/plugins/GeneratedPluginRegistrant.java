...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new dev.atech.qr_code_utils.QrCodeUtilsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin qr_code_utils_android, dev.atech.qr_code_utils.QrCodeUtilsPlugin", e);
    }
  }
}
